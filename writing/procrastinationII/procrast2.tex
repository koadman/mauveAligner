...
\begin{figure}[t]
\centering \epsfig{file=./figures/hmm.eps,width=4.5in}
...
We have extended previous results by converting chains of ungapped multi-matches into  into to local multiple alignments. \textbf{FIXME when results are ready...}
