...
\begin{figure}[p]
\begin{center}
\epsfig{file=./fig/extension.pdf,width=5.4in}
...
$|M_i| \geq 2~\forall~M \in \mathbf{M}$.  
...
\section{Resolving redundant alignments}
\textbf{FIXME..}
...
\centering
\subfigure[]{
\epsfig{file=./fig/procrast_boundary_fig.pdf,width=2.7in}
\label{fig:subfig1}}
\subfigure[]{
\epsfig{file=./fig/euler_boundary_fig.pdf,width=2.7in}
\label{fig:subfig2}}
...
pattern. 
\begin{figure}[t!]
\centering \epsfig{file=./fig/alu_align.pdf,width=5.8in}
