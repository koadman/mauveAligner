...
with a set of local multiple alignments. First we (A) Construct
...
they are related by common ancestry. However, since we do not know repeat boundaries a priori, it is possible that our method forcibly aligns unrelated
...
probabilities derived from an arbitrary substitution  matrix (i.e. HOXD)
