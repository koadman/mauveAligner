...
are short.  Evolution of repeat families was simulated on as a marked 
...
aligned. We calculate the all-pairs boundary prediction accuracy by
...
rates, \texttt{procrastAligner} performs notably better at higher
mutation rates. And for overpredictions, overall
\texttt{procrastAligner} shows better performance, although it is
